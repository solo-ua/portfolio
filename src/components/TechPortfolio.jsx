...
export default function TechPortfolio() {
  ...
  return (
    <div className="tech-portfolio-container" id="tech-portfolio">
      ...
      <section id="tech-experience" className="tech-section tech-border-t">
        <div className="container">
          ...
          <div className="tech-timeline">
            ...
            {/* Job 1 */}
            <div className="tech-timeline-item fade-in visible">
      ...
      {/* ── Section 3: Projects ── */}
      <section id="tech-projects" className="tech-section tech-border-t">
        <div className="container">
          <span className="section-label">03 / CODE REPOSITORIES</span>
          <h2 className="tech-italic-title">Featured Projects</h2>
          
          <div className="tech-projects-grid">
            {projects.map((proj, idx) => (
              <div className="tech-project-card fade-in visible" key={idx}>
      ...
      {/* ── Section 4: Skills ── */}
      <section id="tech-skills" className="tech-section tech-border-t">
        <div className="container">
          ...
          <div className="tech-skills-grid">
            {Object.entries(techSkills).map(([category, items], idx) => (
              <div className="tech-skill-card fade-in visible" key={idx}>
      ...
      {/* ── Section 5: Education ── */}
      <section id="tech-education" className="tech-section tech-border-t">
        <div className="container">
          <span className="section-label">05 / ACADEMIC RECORD</span>
          <h2 className="tech-italic-title">Education</h2>
          
          <div className="tech-education-card fade-in visible">
